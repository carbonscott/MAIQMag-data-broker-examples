...
def generate(output_dir, n_entities=10):
    ...
    # Write Parquet files — named to match dataset config stem
    ent_out = output_dir / "nips3_multimodal_synthetic_entities.parquet"
    art_out = output_dir / "nips3_multimodal_synthetic_artifacts.parquet"
